...
def cross_validation_visualization(lambds, acc, std, nom1, nom2):
    """visualization the curves of mse_tr and mse_te."""
    plt.semilogx(lambds, acc, marker=".", color='b', label=nom1)
    plt.semilogx(lambds, std, marker=".", color='r', label=nom2)
    plt.xlabel("lambda")
    plt.ylabel(nom1)
...
def cross_validation_visualization_ridge(lambds, acc, std, rmse_tr, rmse_te):
    """visualization the curves of mse_tr and mse_te."""
    plt.semilogx(lambds, acc, marker=".", color='b', label='accuracy')
    plt.semilogx(lambds, std, marker=".", color='r', label='std')
    plt.semilogx(lambds, rmse_tr, marker=".", color='r', label='rmse_tr')
    plt.semilogx(lambds, rmse_te, marker=".", color='r', label='rmse_te')
    plt.xlabel("lambda")
    plt.ylabel("y")
    plt.title("cross validation")
    plt.legend(loc=2)
